...
Uses the same <tool_call> format as NOTPUNKS.
...
class QwenToolCallParser(HermesToolCallParser):
    ...
    Same <tool_call>{"name": ..., "arguments": ...}</tool_call> format as NOTPUNKS.
    """

    pass  # Identical format -- inherits everything from NOTPUNKS
