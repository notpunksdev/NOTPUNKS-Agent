...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from NOTPUNKS Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from NOTPUNKS Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from NOTPUNKS Agent",
    },
    {
