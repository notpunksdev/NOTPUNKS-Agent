...
```text
Linux x64:   https://github.com/notpunksdev/NOTPUNKS-Agent/releases/download/v0.11.0/NOTPUNKS-Agent-0.11.0-linux-x64.tar.gz
macOS ARM64: https://github.com/notpunksdev/NOTPUNKS-Agent/releases/download/v0.11.0/NOTPUNKS-Agent-0.11.0-macos-arm64.tar.gz
Windows WSL: https://github.com/notpunksdev/NOTPUNKS-Agent/releases/download/v0.11.0/NOTPUNKS-Agent-0.11.0-windows-wsl.zip
Checksums:   https://github.com/notpunksdev/NOTPUNKS-Agent/releases/download/v0.11.0/checksums.txt
```
...
- Latest release: https://github.com/notpunksdev/NOTPUNKS-Agent/releases/tag/v0.11.0
