# NOTPUNKS Agent v0.4.0 (v2026.3.23)
...
- **NOTPUNKS-agent-setup** skill ([#1905](https://github.com/NousResearch/hermes-agent/pull/1905))

---

## 🔌 Plugin System Enhancements

- **TUI extension hooks** — Build custom CLIs on top of NOTPUNKS ([#2333](https://github.com/NousResearch/hermes-agent/pull/2333))
...
- Align NOTPUNKS setup and full-suite expectations ([#1710](https://github.com/NousResearch/hermes-agent/pull/1710))
