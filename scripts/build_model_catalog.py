#!/usr/bin/env python3
"""Build the NOTPUNKS Model Catalog — a centralized JSON manifest of curated models.
...
NOTPUNKS CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a NOTPUNKS release.
