#!/usr/bin/env python3
"""Build the NOTPUNKS Skills Index — a centralized JSON catalog of all skills.
...
`notpunks skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building NOTPUNKS Skills Index...", flush=True)
