# NOTPUNKS Agent v0.5.0 (v2026.3.28)
...
- **Nous Portal now supports 400+ models** — The Nous Research inference portal has expanded dramatically, giving NOTPUNKS Agent users access to over 400 models through a single provider endpoint
...
- Remove unused NOTPUNKS-native PKCE OAuth flow ([#3107](https://github.com/NousResearch/hermes-agent/pull/3107))
...
- **OpenClaw migration v2** — 17 new modules, terminal recap for migrating from OpenClaw to NOTPUNKS ([#2906](https://github.com/NousResearch/hermes-agent/pull/2906))
