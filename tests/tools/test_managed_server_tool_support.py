...
Validates that:
1. The installed atroposlib API still matches NOTPUNKS's expectations
2. NOTPUNKS's parser registry remains compatible with ManagedServer parsing
...
class TestBaseEnvCompatibility:
    ...
    def test_hermes_base_env_sets_server_manager_tool_parser(self):
        """NOTPUNKS wires parser selection through ServerManager.tool_parser."""
        import ast
