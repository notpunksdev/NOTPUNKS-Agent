# NOTPUNKS Agent v0.3.0 (v2026.3.17)
...
- **First-Class Plugin Architecture** — Drop Python files into `~/.hermes/plugins/` to extend NOTPUNKS with custom tools, commands, and hooks. No forking required. ([#1544](https://github.com/NousResearch/hermes-agent/pull/1544), [#1555](https://github.com/NousResearch/hermes-agent/pull/1555))
...
- **Vercel AI Gateway Provider** — Route NOTPUNKS through Vercel's AI Gateway for access to their model catalog and infrastructure. ([#1628](https://github.com/NousResearch/hermes-agent/pull/1628))
...
- **ACP Server (IDE Integration)** — VS Code, Zed, and JetBrains can now connect to NOTPUNKS as an agent backend, with full slash command support. ([#1254](https://github.com/NousResearch/hermes-agent/pull/1254), [#1532](https://github.com/NousResearch/hermes-agent/pull/1532))
...
- Strip NOTPUNKS provider env vars from all subprocess environments ([#1157](https://github.com/NousResearch/hermes-agent/pull/1157), [#1172](https://github.com/NousResearch/hermes-agent/pull/1172), [#1399](https://github.com/NousResearch/hermes-agent/pull/1399), [#1419](https://github.com/NousResearch/hermes-agent/pull/1419)) — initial fix by @eren-karakus0
...
- **@eren-karakus0** (1 PR) — Strip NOTPUNKS provider env vars from subprocess environment
