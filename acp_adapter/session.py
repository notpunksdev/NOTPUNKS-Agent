"""ACP session manager — maps ACP sessions to NOTPUNKS AIAgent instances.
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed NOTPUNKS agent."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by NOTPUNKS AIAgent instances.
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            agent_factory: Optional callable that creates an AIAgent-like object.
                           ...
                           using the current NOTPUNKS runtime provider configuration.
