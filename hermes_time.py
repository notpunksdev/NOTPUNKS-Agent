"""
Timezone-aware clock for NOTPUNKS.
...
Invalid timezone values log a warning and fall back safely — NOTPUNKS never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — NOTPUNKS requires 3.9+)
