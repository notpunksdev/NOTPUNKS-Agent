...
.. code-block:: yaml
    ...
    branding:
      agent_name: "NOTPUNKS Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ◆ NOTPUNKS "      # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "NOTPUNKS Agent"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "colors": {
            ...
            "wallet_connected": "#4caf50",
            "wallet_disconnected": "#ef5350",
            "nft_rarity_common": "#888888",
            "nft_rarity_uncommon": "#00FF88",
            "nft_rarity_rare": "#FFD700",
            "nft_rarity_epic": "#FF00FF",
            "nft_rarity_legendary": "#FF0080",
        },
        "spinner": {
            "waiting_faces": ["⠿", "⠶", "⠧", "⠏", "◆", "◇", "◈"],
            "thinking_faces": ["⠿", "⠶", "⠧", "⠏", "◆", "◇", "◈"],
            "thinking_verbs": [
                "hashing", "verifying", "scanning", "indexing", "routing",
                "mounting sNFT", "checking wallet", "syncing skills",
                "resolving context", "compiling plan", "signing intent",
                "packing cartridge", "reading memory", "mapping tools"
            ]
        },
        "branding": {
            "agent_name": "NOTPUNKS Agent",
            "welcome": "Welcome to NOTPUNKS Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ◆ NOTPUNKS ",
            "prompt_symbol": "❯ ",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "notpunks": {
        "name": "notpunks",
        "description": "NOTPUNKS — pixel art punk aesthetic, neon on black",
        "colors": {
            "banner_border": "#FF0099",
            "banner_title": "#FF00CC",
            "banner_accent": "#00F0FF",
            "banner_dim": "#BF00FF",
            "banner_text": "#F5F5F5",
            "ui_accent": "#00FFFF",
            "ui_label": "#FF33AA",
            ...
            "prompt": "#FFFFFF",
            "input_rule": "#FF0099",
            "response_border": "#00F0FF",
            "status_bar_bg": "#0A0A0A",
            "status_bar_text": "#FFFFFF",
            "status_bar_strong": "#FF0099",
            "status_bar_dim": "#FF00FF",
            "status_bar_good": "#39FF14",
            "status_bar_warn": "#FFFF00",
            "status_bar_bad": "#FF0033",
            "status_bar_critical": "#FF0000",
            "session_label": "#FF00CC",
            "session_border": "#FF0099",
            "completion_menu_bg": "#0A0A0A",
            "completion_menu_current_bg": "#00F0FF",
            "completion_menu_meta_bg": "#111111",
            "completion_menu_meta_current_bg": "#00F0FF",
            "voice_status_bg": "#0A0A0A",
            "wallet_connected": "#39FF14",
            "wallet_disconnected": "#FF0033",
            "nft_rarity_common": "#AAAAAA",
            "nft_rarity_uncommon": "#39FF14",
            "nft_rarity_rare": "#FFFF00",
            "nft_rarity_epic": "#FF00FF",
            "nft_rarity_legendary": "#FF0099",
        },
        "spinner": {
            "waiting_faces": ["(◆)", "(▪)", "(■)", "(◼)", "(◾)"],
            "thinking_faces": ["(◆)", "(▪)", "(■)", "(◼)", "(◾)"],
            "thinking_verbs": [
                "mining", "rendering", "punking", "hashing", "minting",
                "pixelating", "glitching", "vibing",
            ],
        },
        "branding": {
            "agent_name": "NOTPUNKS Agent",
            "welcome": "NOTPUNKS Agent ready. Type your message or /help for commands.",
            "goodbye": "Later! ◆",
            "response_label": " ◆ NOTPUNKS ",
            "prompt_symbol": "▪ ",
...
_active_skin_name: str = "notpunks"
...
def init_skin_from_config(config: dict) -> None:
    ...
    if not isinstance(display, dict):
        display = {}
    skin_name = display.get("skin", "notpunks")
    if isinstance(skin_name, str) and skin_name.strip():
        set_active_skin(skin_name.strip())
    else:
        set_active_skin("notpunks")
