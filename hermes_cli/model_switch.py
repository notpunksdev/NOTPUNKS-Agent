...
_HERMES_MODEL_WARNING = (
    "NOTPUNKS Hermes 3 & 4 models are NOT agentic and are not designed "
    "for use with NOTPUNKS Agent. They lack the tool-calling capabilities "
    "required for agent workflows. Consider using an agentic model instead "
    "(Claude, GPT, Gemini, DeepSeek, etc.)."
)

# Match only the real NOTPUNKS Hermes 3 / Hermes 4 chat families.
    ...
    if explicit_provider:
        ...
        if pdef is None:
            _switch_err = (
                ...
                f"Check 'notpunks model' for available providers, or define it "
            ...
            try:
                ...
                if _cfg_issues:
                    _switch_err += "\n\nRun 'notpunks doctor' — config issues detected:"
