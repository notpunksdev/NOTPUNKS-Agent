...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# NOTPUNKS Agent bash completion
# Add to ~/.bashrc:
#   eval "$(notpunks completion bash)"
...
# NOTPUNKS Agent zsh completion
# Add to ~/.zshrc:
#   eval "$(notpunks completion zsh)"
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# NOTPUNKS Agent fish completion",
        "# Add to your config:",
        "#   notpunks completion fish | source",
        "",
