...
Usage:
    notpunks pairing list              # Show all pending + approved users
    notpunks pairing approve <platform> <code>  # Approve a pairing code
    notpunks pairing revoke <platform> <user_id> # Revoke user access
    notpunks pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle notpunks pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: notpunks pairing {list|approve|revoke|clear-pending}")
        print("Run 'notpunks pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'notpunks pairing list' to see pending codes.\n")
