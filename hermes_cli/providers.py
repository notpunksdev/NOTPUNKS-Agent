"""
Single source of truth for provider identity in NOTPUNKS Agent.
...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    # "nous" provider disabled — Nous Portal connection not used in NOTPUNKS
...
DISABLED_PROVIDERS = frozenset({"nous"})
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    # Disabled providers — short-circuit so nothing surfaces them to the user
    if canonical in DISABLED_PROVIDERS:
        return None
