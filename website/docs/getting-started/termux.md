...
description: "Run NOTPUNKS Agent directly on an Android phone with Termux"
---

# NOTPUNKS on Android with Termux

This is the tested path for running NOTPUNKS Agent directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop NOTPUNKS from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

NOTPUNKS now ships a Termux-aware installer path:
...
```bash
git clone --recurse-submodules https://github.com/notpunksdev/NOTPUNKS-Agent.git
cd hermes-agent
```
