...
description: "How to update NOTPUNKS Agent to the latest version or uninstall it"
---
...
✅ Gateway restarted
✅ NOTPUNKS Agent updated successfully!
```
...
Compare against the latest release at the [GitHub releases page](https://github.com/notpunksdev/NOTPUNKS-Agent/releases).
