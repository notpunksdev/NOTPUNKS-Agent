...
description: "Reference for NOTPUNKS core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call NOTPUNKS tools programmatically. |
