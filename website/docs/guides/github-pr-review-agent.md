...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  NOTPUNKS Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to NOTPUNKS instantly when PRs are opened or updated.
:::
...
- **NOTPUNKS Agent installed** — see the [Installation guide](/docs/getting-started/installation)
...
Make sure NOTPUNKS can access GitHub. Start a chat:
...
Still in the chat, ask NOTPUNKS to review a real PR:
...
A skill gives NOTPUNKS consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach NOTPUNKS your team's standards:
...
2. Teach NOTPUNKS your conventions via memory (Step 4)
