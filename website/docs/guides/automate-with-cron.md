...
description: "Real-world automation patterns using NOTPUNKS cron — monitoring, reports, pipelines, and multi-skill workflows"
---
...
req = urllib.request.Request(URL, headers={"User-Agent": "NOTPUNKS-Monitor/1.0"})
