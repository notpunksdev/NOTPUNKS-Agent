---
sidebar_position: 8
title: "Use Voice Mode with NOTPUNKS"
description: "A practical guide to setting up and using NOTPUNKS voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with NOTPUNKS
...
- you want NOTPUNKS sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in NOTPUNKS.
...
## Step 1: make sure normal NOTPUNKS works first
...
NOTPUNKS supports both local and cloud speech stacks.
...
4. NOTPUNKS transcribes and responds
...
- asking NOTPUNKS to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full NOTPUNKS loop.

## Tuning CLI behavior

### Silence threshold

If NOTPUNKS starts/stops too aggressively, tune:
...
NOTPUNKS stays a normal chat bot, but can speak replies.
...
- you want NOTPUNKS to function like a portable research or ops assistant
...
NOTPUNKS joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- NOTPUNKS detects speech boundaries
- transcripts are posted in the associated text channel
- NOTPUNKS responds in text and audio
