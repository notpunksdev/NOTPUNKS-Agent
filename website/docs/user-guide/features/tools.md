...
description: "Overview of NOTPUNKS Agent's tools — what's available, how toolsets work, and terminal backends"
---
...
NOTPUNKS ships with a broad built-in tool registry covering web search, browser automation, terminal execution, file editing, memory, delegation, RL training, messaging delivery, Home Assistant, and more.
