...
## NOTPUNKS Agent Integration

This skill is designed for the NOTPUNKS agent. It uses NOTPUNKS tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other NOTPUNKS skills for specific phases:
