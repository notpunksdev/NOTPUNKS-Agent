...
| Version | `1.1.0` |
| Author | NOTPUNKS Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For NOTPUNKS:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use NOTPUNKS tools to understand the project:
