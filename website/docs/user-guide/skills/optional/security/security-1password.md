...
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by NOTPUNKS Agent |
| License | MIT |
...
- `tmux` available for stable authenticated sessions during NOTPUNKS terminal calls (desktop app flow only)
...
### Service Account (recommended for NOTPUNKS)
...
## NOTPUNKS Execution Pattern (desktop app flow)

NOTPUNKS terminal commands are non-interactive by default and can lose auth context between calls.
