...
- User wants **NOTPUNKS itself to drive a browser** → use NOTPUNKS' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
