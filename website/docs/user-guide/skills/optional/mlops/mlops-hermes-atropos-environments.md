---
title: "NOTPUNKS Atropos Environments — Build, test, and debug NOTPUNKS Agent RL environments for Atropos training"
sidebar_label: "NOTPUNKS Atropos Environments"
description: "Build, test, and debug NOTPUNKS Agent RL environments for Atropos training"
---

{/* This page is auto-generated from the skill's SKILL.md by website/scripts/generate-skill-docs.py. Edit the source SKILL.md, not this page. */}

# NOTPUNKS Atropos Environments

Build, test, and debug NOTPUNKS Agent RL environments for Atropos training. Covers the HermesAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the hermes-agent repo.
...
# NOTPUNKS Agent Atropos Environments
...
NOTPUNKS environments are special because they run a **multi-turn agent loop with tool calling** — not just single-turn completions. The base env handles the loop; you implement the task and scoring.
