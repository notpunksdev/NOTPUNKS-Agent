...
description: "How NOTPUNKS builds the system prompt, preserves cache stability, and injects ephemeral layers"
---

# Prompt Assembly

NOTPUNKS deliberately separates:
...
You are NOTPUNKS, an AI assistant created by Nous Research.
...
```
You are NOTPUNKS Agent, an intelligent AI assistant created by Nous Research.
...
|----------|-------|-------------|-------|
| 1 | `.hermes.md`, `HERMES.md` | CWD up to git root | NOTPUNKS-native project config |
