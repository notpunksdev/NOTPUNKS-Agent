...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full NOTPUNKS toolsets (CLI + messaging platforms)
    #
    ...
    "hermes-cron": {
        ...
        # core tools users see interactively — then `notpunks tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant, rl) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hermes-cli; gated by `notpunks tools`",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-email": {
        "description": "Email bot toolset - interact with NOTPUNKS via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hermes-sms": {
        "description": "SMS bot toolset - interact with NOTPUNKS via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
