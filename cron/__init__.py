"""
Cron job scheduling system for NOTPUNKS Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    notpunks gateway install    # Install as a user service
    sudo notpunks gateway install --system  # Linux servers: boot-time system service
    notpunks gateway            # Or run in foreground
