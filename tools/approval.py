...
DANGEROUS_PATTERNS = [
    ...
    (r'\bhermes\s+gateway\s+(stop|restart)\b', "stop/restart notpunks gateway (kills running agents)"),
    (r'\bhermes\s+update\b', "notpunks update (restarts gateway, kills running agents)"),
