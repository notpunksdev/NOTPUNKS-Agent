...
Lets the LLM write a Python script that calls NOTPUNKS tools via RPC,
...
"""Auto-generated NOTPUNKS tools RPC stubs."""
...
"""Auto-generated NOTPUNKS tools RPC stubs (file-based transport)."""
...
def execute_code(
    ...
    try:
        ...
        # HERMES_TIMEZONE is an internal NOTPUNKS setting and must not leak
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    When tools are disabled via ``notpunks tools`` (e.g. web is turned off),
    ...
    description = (
        "Run a Python script that can call NOTPUNKS tools programmatically. "
