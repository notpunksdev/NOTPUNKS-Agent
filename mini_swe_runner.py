#!/usr/bin/env python3
"""
SWE Runner with NOTPUNKS Trajectory Format

A runner that uses NOTPUNKS-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the NOTPUNKS-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses NOTPUNKS-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in NOTPUNKS format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches NOTPUNKS-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using NOTPUNKS-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with NOTPUNKS Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses NOTPUNKS-Agent's built-in execution environments
    and outputs trajectories in NOTPUNKS-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to NOTPUNKS trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to NOTPUNKS trajectory format
...
def main(
    ...
    """
    Run SWE tasks with NOTPUNKS trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with NOTPUNKS Trajectory Format")
    print("=" * 60)
