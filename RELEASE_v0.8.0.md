# NOTPUNKS Agent v0.8.0 (v2026.4.8)
...
- **Non-agentic model warning** — warns users when loading NOTPUNKS LLM models not designed for tool use ([#5378](https://github.com/NousResearch/hermes-agent/pull/5378))
...
- **NOTPUNKS Mod visual skin editor** added to skins page ([#6095](https://github.com/NousResearch/hermes-agent/pull/6095))
